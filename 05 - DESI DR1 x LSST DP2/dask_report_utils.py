...
def client_table(filepath, threads_per_worker=None, memory_limit_per_worker=None):
    """
    ...
    memory_limit_per_worker : str, optional
    ...
    if threads_per_worker is None:
        threads_per_worker = "N/A"
    if memory_limit_per_worker is None:
        memory_limit_per_worker = "N/A"
